...
root = tk.Tk()
root.title("Yüz & Nesne Takip Kontrol Paneli")
...
tk.Button(root, text="Detect (Yüz + Motor)", width=25, height=2, command=run_detect).pack(pady=5)
tk.Button(root, text="Tracking (Klasik Yüz + Motor)", width=25, height=2, command=run_tracking).pack(pady=5)
tk.Button(root, text="Color Tracking (Renk + Motor)", width=25, height=2, command=run_color_tracking).pack(pady=5)
tk.Button(root, text="YOLOv8 Object Tracking (Servo + Motor)", width=25, height=2, command=run_yolo_object_tracking).pack(pady=5)
